...
class User extends CI_Controller {
	...
	public function index()
	{
		...
		$this->load->view('lihat' , $data);//membuka form index dan memasukkan variabel data
	}

	// Add a new item
	public function add()
	{
		$this->load->view('LoginIndoTravel/user');//memanggil form untuk input data yg berada di folder user
	}
